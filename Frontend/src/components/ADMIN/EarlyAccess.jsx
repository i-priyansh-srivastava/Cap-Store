...
import '../../styles/ADMIN/EarlyAccess.css';

const EarlyProductForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/v1/earlyAccess', payload);
...
export default EarlyProductForm;
